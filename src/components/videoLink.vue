<template>
	...
	<div v-show='loading'>
		...
		<v-layout justify-center>
			<v-progress-circular v-show='loading' indeterminate v-bind:size="100" v-bind:width="7" class="white--text"></v-progress-circular>
		</v-layout>
	</div>
	...
	<div v-show='!loading'>
		<div class="sidecol grey lighten-3 elevation-5" v-resize='onResize'>	
				...
				<img style='margin-top:-10%' :src='vData.iurl' width="100%" />
